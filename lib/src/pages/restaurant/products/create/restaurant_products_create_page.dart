...
import 'package:delibery_integrado_enrique/src/pages/restaurant/products/create/restaurant_products_create_controller.dart';
    ...
    return GestureDetector(
      ...
      child: imageFile != null
        ...
        child: Container(
          ...
          width: MediaQuery.of(context).size.width * 0.26,
          child: Image(
            image: AssetImage('assets/img/agregarplatillo.png'),
          ),
        ),
      ),
    );

import 'package:delibery_integrado_enrique/src/pages/client/update/client_update_controller.dart';
  ...
  Widget _textFieldName() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Color(0xFF4A8099).withOpacity(0.3),
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(color: Color(0xFF4A8099)),
          prefixIcon: Icon(
            Icons.person,
            color: Color(0xFF4A8099),
          ),
        ),
      ),
    );
